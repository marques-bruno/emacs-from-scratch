...
(custom-set-variables
 ...
 '(package-selected-packages
   '(evil-tutor yasnippet-snippets yaml-mode yafolding which-key wakatime-mode vterm visual-fill-column use-package typescript-mode rustic rainbow-delimiters pyvenv python-mode org-bullets no-littering lsp-ui lsp-ivy ivy-rich ivy-prescient helpful helm-xref helm-lsp google-c-style general forge flycheck exwm exec-path-from-shell evil-nerd-commenter evil-collection eterm-256color eshell-git-prompt doom-themes doom-modeline dired-single dired-open dired-hide-dotfiles desktop-environment dap-mode counsel-projectile company-box command-log-mode cmake-project cmake-mode clang-format auto-package-update all-the-icons-dired)))
(custom-set-faces
